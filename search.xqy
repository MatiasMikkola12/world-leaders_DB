...
{fn:count(/wl:leader)} Present: {co:in-office()}
  ...
  <div id="graybar"><form name="formsearch" method="get" action="search.xqy" id="formsearch">  <p>Enter a search term: </p> 
<input type="text" name="term" id="term" value="{xdmp:get-request-field("term")}"/>  <input type="submit" name="submitbtn" id="submitbtn" value="Go"/> 
</form></div>
  <div id="content">
   <table cellspacing="0">
    <tr>
